...
import { fetchSubscriptionStatus, getButtonText } from '../../services/utils';
...
const PlanCard = ({
    ...
    const handleSubscribe = async () => {
        const hasActiveCancelledPlan =
            currentPlan?.status === 'cancelled' &&
            new Date(currentPlan.planEnd) > new Date();

        if (hasActiveCancelledPlan) {
            alert('You have an active cancelled subscription. Please wait until the end of your billing period to subscribe again.');
            return;
        }
        try {
